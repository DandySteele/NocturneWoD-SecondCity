...
/datum/bodypart_overlay/mutant/proc/build_icon_state(layer_index, obj/item/bodypart/limb)
	...
	return "[gender_key]_[feature_key_sprite ? feature_key_sprite : feature_key]_[base_state]_[layer_index]" // NOCTURNE EDIT - ORIGINAL: return "[gender_key]_[feature_key]_[base_state]_[layer_index]"
