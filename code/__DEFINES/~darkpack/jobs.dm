...
#define JOB_DISPLAY_ORDER_TH_MAYORAIDE 1
#define JOB_DISPLAY_ORDER_TH_CLERK 2
#define JOB_DISPLAY_ORDER_FARMER 3
#define JOB_DISPLAY_ORDER_CHEF 4
#define JOB_DISPLAY_ORDER_SALON 5
#define JOB_DISPLAY_ORDER_STREETJAN 6
#define JOB_DISPLAY_ORDER_STRIP 7
#define JOB_DISPLAY_ORDER_TAXI 8
#define JOB_DISPLAY_ORDER_PRIEST 9
...
#define JOB_DISPLAY_ORDER_DANCER 7 // NOCTURNE ADDITION
...
// NOCTURNE ADDITION START
#define JOB_DISPLAY_ORDER_CAPO 1
#define JOB_DISPLAY_ORDER_SQUADRA 2
#define JOB_DISPLAY_ORDER_FAMIGLIA 3
// NOCTURNE ADDITION END
...
// NOCTURNE ADDITION START
#define JOB_DISPLAY_ORDER_MAGADON_CORP_HEAD 1
#define JOB_DISPLAY_ORDER_MAGADON_CORP_MIDDLE_MANAGER 2
#define JOB_DISPLAY_ORDER_MAGADON_SECURITY_CHIEF 3
#define JOB_DISPLAY_ORDER_MAGADON_SECURITY 4
#define JOB_DISPLAY_ORDER_MAGADON_DOCTOR 5

#define JOB_DISPLAY_ORDER_HUNTER_CELL_HEAD 1
#define JOB_DISPLAY_ORDER_HUNTER_CELL_SOLDIER 2
// NOCTURNE ADDITION END
...
// NOCTURNE ADDITION START
#define DEPARTMENT_BITFLAG_MAGADON (1<<17)
#define DEPARTMENT_MAGADON "Magadon"
#define DEPARTMENT_BITFLAG_HUNTER (1<<18)
#define DEPARTMENT_HUNTER "Bushwhacker"
// NOCTURNE ADDITION END
...
DEFINE_BITFIELD(departments_bitflags, list(
	...
	"CHANTRY" = DEPARTMENT_BITFLAG_CHANTRY,
	"CITY_SERVICES" = DEPARTMENT_BITFLAG_CITY_SERVICES,
	"MAGADON" = DEPARTMENT_BITFLAG_MAGADON,
	"HUNTER" = DEPARTMENT_BITFLAG_HUNTER,
))
// NOCTURNE ADDITION END
...
// NOCTURNE ADDITION START
#define EXP_TYPE_MAGADON "Magadon"
#define EXP_TYPE_HUNTER "Hunter"
// NOCTURNE ADDITION END
