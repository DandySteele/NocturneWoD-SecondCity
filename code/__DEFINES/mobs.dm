...
#define ID_LAYER 18
	...
	#define BODY_FRONT_UNDER_CLOTHES_LAYER 18.5
	// NOCTURNE EDIT END
/// Jumpsuit clothing layer
#define UNIFORM_LAYER 19
	// NOCTURNE EDIT START
	#define UNDERWEAR_UNDERSHIRT 19.1
	#define BRA_SOCKS_LAYER 19.2
	// NOCTURNE EDIT END
	/// The layer underneath the uniform
	#define UNDER_UNIFORM_LAYER 19.5 // NOCTURNE EDIT - ORIGINAL: #define UNDER_UNIFORM_LAYER 19.1
...
#define BODY_LAYER 22
	// NOCTURNE EDIT START
	#define BODY_ADJ_LAYER_3 22.7
	#define BODY_ADJ_LAYER_2 22.8
	// NOCTURNE EDIT END
...
#define EXTERNAL_BODY_FRONT_UNDER_CLOTHES "FRONT_UNDER"
